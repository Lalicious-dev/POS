...
<div class="container-fluid px-4">
    ...
    @can('crear-cliente')
    <div class="mb-4">
        <a href="{{route('clientes.create')}}"><button type="button" class="btn btn-primary">Añadir nuevo registro</button>
        </a>
    </div>
    @endcan
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('clientes.importar')}}" enctype="multipart/form-data" id="form_carga_clientes" method="post">
                            @csrf
                            <label for="fileClientes" class="form-label">Seleccionar Archivo de Carga (Excel):</label>
                            <input type="file" name="fileClientes" id="fileClientes" class="form-control" accept=".xls,.xlsx">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar clientes</button>
                            </div>
                            @error('fileClientes')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('clientes.importartxt')}}" enctype="multipart/form-data" id="form_carga_clientesT" method="post">
                            @csrf
                            <label for="fileClientesT" class="form-label">Seleccionar Archivo de Carga (Txt):</label>
                            <input type="file" name="fileClientesT" id="fileClientesT" class="form-control" accept=".txt">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar clientes</button>
                            </div>
                            @error('fileClientesT')
