...
<div class="container-fluid px-4">
    ...
    @can('ver-user')
        <!-- Barra de alerta--->
        <div class="p-1 border-3 rounded col-md-12 mb-2" id="barra" style="height: auto; padding: 10px;">
            <div>
                <!---Fecha--->

                <p class="text-center fs-5 text-white">Tu próxima declaración ante el SAT vence el <span id="fecha" class="fw-bold"></span>. Faltan:</p>
                <!---Cuenta atras--->
                <div class="d-flex justify-content-center p-1 gx-md-3">
                    <div class="row m-1">
                        <p id="dias" class="text-white fw-bold">00</p>
                        <p class="text-white">días</p>
                    </div>
                    <div class="row m-1">
                        <p id="horas" class="fw-bold text-white">00</p>
                        <p class="text-white">horas</p>
                    </div>
                    <div class="row m-1">
                        <p id="minutos" class="fw-bold text-white">00</p>
                        <p class="text-white">minutos</p>
                    </div>
                    <div class="row m-1">
                        <p id="segundos" class="fw-bold text-white">00</p>
                        <p class="text-white">segundos</p>
                    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            <i class="fa-solid fa-box"></i><span class="m-1">Presentaciones</span>
                        </div>
                        <div class="col-4">
                            <?php
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-warning text-white mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            <i class="fa-solid fa-truck-ramp-box"></i><span class="m-1">Proveedores</span>
                        </div>
                        <div class="col-4">
                            <?php
...
<script>
    ...
    spanFecha.innerText = fecha.toLocaleDateString('es-MX', {
        day: '2-digit',
        month: 'long',
        year: 'numeric'
    });
    ...
    setInterval(() => {
        ...
        // Limpia las clases de fondo anteriores
        barra.classList.remove('bg-dark', 'bg-success', 'bg-warning', 'bg-danger');

        // Agrega la clase adecuada según los días restantes
        if (dias <= 3) {
