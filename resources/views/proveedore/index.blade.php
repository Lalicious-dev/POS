...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('proveedores.create')}}"><button type="button" class="btn btn-primary">Añadir nuevo registro</button>
        </a>
    </div>
    @endcan
    @can('importar-proveedore')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('proveedores.importar')}}" enctype="multipart/form-data" id="form_carga_proveedores" method="post">
                            @csrf
                            <label for="fileProveedores" class="form-label">Seleccionar Archivo de Carga (Excel):</label>
                            <input type="file" name="fileProveedores" id="fileProveedores" class="form-control" accept=".xls,.xlsx">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar proveedores</button>
                            </div>
                            @error('fileProveedores')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('proveedores.importartxt')}}" enctype="multipart/form-data" id="form_carga_proveedoresT" method="post">
                            @csrf
                            <label for="fileProveedoresT" class="form-label">Seleccionar Archivo de Carga (Txt):</label>
                            <input type="file" name="fileProveedoresT" id="fileProveedoresT" class="form-control" accept=".txt">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar proveedores</button>
                            </div>
                            @error('Proveedores')
