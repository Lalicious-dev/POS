...
<div class="container-fluid px-4">
    ...
    @can('crear-producto')
    <div class="mb-4">
        <a href="{{route('productos.create')}}"><button type="button" class="btn btn-primary">Añadir nuevo registro</button>
        </a>
    </div>
    @endcan
    @can('importar-producto')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('productos.importar')}}" enctype="multipart/form-data" id="form_carga_productos" method="post">
                            @csrf
                            <label for="fileProductos" class="form-label">Seleccionar Archivo de Carga (Excel):</label>
                            <input type="file" name="fileProductos" id="fileProductos" class="form-control" accept=".xls,.xlsx">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar productos</button>
                            </div>
                            @error('fileProductos')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('productos.importartxt')}}" enctype="multipart/form-data" id="form_carga_productosT" method="post">
                            @csrf
                            <label for="fileProductosT" class="form-label">Seleccionar Archivo de Carga (Txt):</label>
                            <input type="file" name="fileProductosT" id="fileProductosT" class="form-control" accept=".txt">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary mt-2" id="btnCargar">Cargar productos</button>
                            </div>
                            @error('fileProductosT')
                            <small class="text-danger">{{'*'.$message}}</small>
                            @enderror
                        </form>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                @endcan
                                @can('ver-producto')
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#verModal-{{$item->id}}">Ver</button>
                                @endcan
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div>
                                            @if($item->img_path != null)  
                                                <center>
                                                <img src="{{ Storage::url('public/productos/').$item->img_path }}" alt="{{$item->nombre}}" class="img-fluid img-thumbnail">
                                                </center>
                                            @else
                                                <center>
